...
class RegistrationPage(unittest.TestCase):
    ...
    def test01_user_registration(self):
    ...
    def test02_login_as_new_user(self):
    ...
    def test03_user_removal(self):
        ...
        delete_fun_home_button = self.driver.find_element_by_xpath("//tbody//tr[last()]//span[@class='fa fa-trash glyphicon icon-trash']")
